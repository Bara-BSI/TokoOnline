                    ...
                    <div class="row">
                            ...
                            <table class="table table-bordered table-hover display">
                                ...
                                <tfoot>
                                    ...
                                    <tr>
                                        <th class="empty" colspan="3"></th>
                                        <td>TOTAL BAYAR</td>
                                        <td colspan="2" class="total">Rp. {{ number_format($totalHarga + $order->biaya_ongkir, 0, ',', '.') }}</td>
                                    </tr>
                                </tfoot>
                            </table>
                        </div>
                        <div class="col-xs-6 col-sm-6 col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="noresi" id="noresi" value="{{ old('noresi', $order->noresi) }}" class="form-control @error('noresi')
                                    is-invalid
                                @enderror" placeholder="Masukkan Nomor Resi">
                                @error('noresi')
                        ...
                        <div class="col-xs-6 col-sm-6 col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="alamat" id="alamat" class="form-control @error('alamat')
                                    is-invalid
                                @enderror" id="ckeditor">
                                    {{ old('alamat', $order->alamat) }}
                                </textarea>
                                @error('alamat')
                                    <span class="invalid-feedback alert-danger" role="alert">
                                        {{ $message }}
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="pos" id="pos" value="{{ old('pos', $order->pos) }}" class="form-control @error('pos')
                                    is-invalid
                                @enderror" placeholder="Masukkan Nomor Resi">
                                @error('pos')
                                    <span class="invalid-feedback alert-danger" role="alert">
