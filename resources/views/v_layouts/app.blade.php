                    ...
                    <ul class="header-btns">
                            ...
                            <li class="header-account dropdown default-dropdown">
                                ...
                                <ul class="custom-menu">
                                    ...
                                    <li>
                                        ...
                                        {{-- form keluar app --}}
                                        <form action="{{ route('customer.logout') }}" method="post" id="keluar-app" class="d-none">
                                            @csrf
                                        </form>
                                        {{-- form keluar app end --}}
                                    </li>
                        ...
                        @else
                            <li class="header-account dropdown default-dropdown">
                                ...
                                <a href="{{ route('auth.redirect') }}" class="text-upper">Login</a>
                            </li>
                        @endif
                        <!-- /Account -->
                    ...
                    <div class="category-nav">
                        ...
                        <ul class="category-list">
                            @foreach ($kategori as $row)
                                <li><a href="{{ route('produk.kategori', $row->id) }}">
                                    {{ $row->nama_kategori }}
                                </a></li>
                            @endforeach
                        </ul>
